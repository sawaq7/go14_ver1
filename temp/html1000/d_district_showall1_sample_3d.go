package html1000
   ...
   const D_district_showall1_sample_3d = `
   <!DOCTYPE html>
   <html>
     <head>
        <meta charset="UTF-8">
             ...
             <form method="GET" action="/d_district_update" >
               ...
               <td>
                 {{range .D_Area_Slice}}
                  ...
                  {{end}}
                  {{range .D_Area_Slice.D_Area_Small_Slice}}

                   <input type="text" name="district_name" size="10" align="center" value="{{.Area_Small_Name|html}}" />
