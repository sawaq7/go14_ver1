     ...
     <body>
       <header>
         <table border="2" cellpadding="8" align="center" bgcolor="#00ced1">
           <h2 align="center">Key-In Todays' Deliverly number　,please</h2>
       ...
       <article>
         <table border="2" cellpadding="8" align="center" bgcolor="#00ced1">
           ...
           <tr> <th>district-name</th><th>area-name</th> </tr>
           {{range .}}
             ...
             {{ if eq .Line_No 1}}
               ...
               <td>
                  <input type="text" name="course_no" size="5" align="center" value="{{.District_Name|html}}" />
                  <input type="hidden" name="id"  value="{{.Id|html}}"/>
               </td>
               <td>
                  <input type="text" name="course_no" size="5" align="center" value="{{.Area_Name|html}}" />
                  <input type="hidden" name="id"  value="{{.Id|html}}"/>
               </td>
