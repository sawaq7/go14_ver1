...
// 繝輔ぃ繧､繝ｫ繧ｪ繝ｼ繝励Φ
   ...
   fname2 = "C:/Go_Original/src/github.com/sawaq7/go14_ver1/client/tokura/file/grade_line2.txt"
...
// 繝輔ぃ繧､繝ｫ繝ｪ繝ｼ繝繝ｼ繧抵ｼｧ・･・ｴ
   ...
   for {
      ...
      fmt.Println ("main_kansui2 index " ,index)  // 繝・ヰ繝・け
...
//譁・ｭ怜腰菴阪↓繧ｹ繝壹・繧ｹ縺ｧ蛻・牡
      ...
      fmt.Println ("main_kansui2 num " ,num)  // 繝・ヰ繝・け

      if num != 0 {
         if index == 1{

// 繝倥ャ繝繝ｼ繧呈嶌縺・             writer.WriteString(line)
             fmt.Println ("main_kansui2 繝倥ャ繝繝ｼwrite " ,line)  // 繝・ヰ繝・け

          }else{

             fmt.Println ("main_kansui2 繝・・繧ｿwrite " ,line)  // 繝・ヰ繝・け
...
// 蜍墓ｰｴ蜍ｾ驟咲ｷ單own繧蜘rite
          ...
          fmt.Println ("main_kansui2 normal end" )   //繝・ヰ繝・け
