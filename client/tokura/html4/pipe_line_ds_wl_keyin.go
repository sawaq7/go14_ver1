     ...
     <body>
       <article>
          ...
          <section >
            ...
            <form method="GET" action="/pipe_line_ds_wl_show" >
          ...
          <section id="main">
           ...
           {{range .}}
             ...
             <form method="GET" action="/pipe_line_ds_wl_update" >
             ...
             <form method="GET" action="/pipe_line_ds_wl_delete" >
